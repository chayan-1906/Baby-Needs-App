...
//        Log.i ( "MyTAG", "Added Item: " );
    ...
    public Item item(int id) {
        ...
        if (cursor!=null) {
            ...
            String formattedDate = dateFormat.format ( new Date ( cursor.getLong ( cursor.getColumnIndex ( Constants.KEY_DATE_NAME ) ) ).getTime ());   //Oct 18, 2020
